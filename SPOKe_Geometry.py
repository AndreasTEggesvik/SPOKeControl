...
class Dimensions:
	...
	def __init__(self):
		...
		self.LS4Position = 9 * 0.1588 + 0.035 + 0.0178

		self.angularMovementState_1_4 = - 0.5 * 0.1588
		self.angularMovementState_2_5 = 0.1588 # Distance from one clam to the next
		self.initialAngularMovement = 0.134 #0.1358 # Distance to move from the limit switch to the middle of the first two clams
		self.initialAngularMovementBack = 0.073 + 0.1588 + 0.3 * 0.079# self.theta4Max - 0.4 # Distance from left ls to first clam
